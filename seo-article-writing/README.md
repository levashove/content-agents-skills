...
- `rules/common/content-quality.md` → `references/common-content-quality.md`
- `rules/common/brand-terminology.md` → `references/common-brand-terminology.md`
...
- `references/common-brand-terminology.md`
- `references/common-content-quality.md`
