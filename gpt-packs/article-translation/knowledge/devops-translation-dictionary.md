...
- **Смежные словари** (`databases-`, `security-`, `networking-translation-dictionary`) — подключаются параллельно при пересечении тем; при коллизии терминов первый вариант — по Общей таблице `translation-glossary.md`.
