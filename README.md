...
| [`vk-tech-press-release`](vk-tech-press-release/) | Пресс-релизы VK Tech в чате по канону структуры 2026: курсивный лид с выгодой, релиз 250–400 слов, тело сплошным текстом, цитата с тезиса и одной аналитической цифрой максимум, фи… | [`zips/vk-tech-press-release.zip`](zips/vk-tech-press-release.zip) |
...
| [`aeo-trust-blocks`](aeo-trust-blocks/) | AEO (Answer Engine Optimization): как попасть в ответы ChatGPT, Perplexity и Google AI Overviews. | [`zips/aeo-trust-blocks.zip`](zips/aeo-trust-blocks.zip) |
| [`clean-ai-patterns`](clean-ai-patterns/) | Чистка русскоязычного текста от маркеров машинной генерации: канцелярит, пустые связки, параллелизмы и триады ради ритма, псевдоискренность, самокомментирование аргумента, техниче… | [`zips/clean-ai-patterns.zip`](zips/clean-ai-patterns.zip) |

Полное описание, источники правды и состав каждого скилла — в README его папки.

## Версия для ChatGPT

Для части скиллов есть GPT-пак в [`gpt-packs/`](gpt-packs/): [`vk-tech-telegram-posts`](gpt-packs/vk-tech-telegram-posts/), [`seo-article-writing`](gpt-packs/seo-article-writing/), [`vk-tech-press-release`](gpt-packs/vk-tech-press-release/), [`article-translation`](gpt-packs/article-translation/), [`aeo-trust-blocks`](gpt-packs/aeo-trust-blocks/), [`clean-ai-patterns`](gpt-packs/clean-ai-patterns/) — маршрутизатор под поле Instructions кастомного GPT + справочники файлами под Knowledge; инструкция сборки — в README пака.

## Standalone-промты (любой чат-бот)

Версия без механики скиллов и Knowledge — [`prompts/`](prompts/): [`telegram-post-vk-cloud-news.md`](prompts/telegram-post-vk-cloud-news.md), [`telegram-post-k8s.md`](prompts/telegram-post-k8s.md), [`telegram-post-data.md`](prompts/telegram-post-data.md), [`telegram-post-tarantool.md`](prompts/telegram-post-tarantool.md), [`seo-article-writing.md`](prompts/seo-article-writing.md), [`vk-tech-press-release.md`](prompts/vk-tech-press-release.md), [`article-translation.md`](prompts/article-translation.md), [`aeo-trust-blocks.md`](prompts/aeo-trust-blocks.md), [`clean-ai-patterns.md`](prompts/clean-ai-patterns.md). Сокращённый промт (правила + процесс + нужный справочник инлайном): скопируйте файл целиком первым сообщением в чат и следом напишите задачу. Для Telegram — по промту на каждый канал.

## Отдельные репозитории

У части скиллов есть собственный репозиторий с той же сборкой: [`clean-ai-patterns`](https://github.com/levashove/clean-ai-patterns), [`aeo-trust-blocks`](https://github.com/levashove/aeo-trust-blocks). Содержимое идентично папке здесь; отдельный репозиторий удобнее клонировать как папку скилла или ставить звёзды.
